...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(black..":NameBot:")
...
var = 'مطور اساسي' 
elseif  UserID == 1661260546 then
var =  'هيفين مطور السورس'
elseif  UserID == 1726705278 then
var =  'سوريا مبرمج السورس'
elseif  UserID == 1360083579 then
var =  'ماجد الهكر'
elseif redis:sismember(black..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(black..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(black..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(black..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(black..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(black..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(black..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(black..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(black..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(black..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(black..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(black..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(black..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(black..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(black..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(black..':SUDO_BOT:')
message = '❍ ** قائمه الـمـطـوريـن : \n\n`❍ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(black..'username:'..v)
local count = redis:scard(black..'mtwr_count'..v)
...
local monsha = redis:smembers(black..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n❍ قائمه المدراء :*\n\n'
local list = redis:smembers(black..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(black..'admins:'..msg.chat_id_)
...
local list = redis:smembers(black..'whitelist:'..msg.chat_id_)
...
if redis:sismember(black..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(black..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(black..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(black..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(black..'gban_users')
...
local list = redis:smembers(black..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(black..':Filter_Word:'..msg.chat_id_,word) then 
return  "❍ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(black..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(black..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(black..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(black..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(black..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(black..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(black..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(black..'group:ids')
message = '❍ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(black..'group:name'..v)
if info then 
...
redis:del(
black..'group:add'..id_group,
black..'lock_link'..id_group, 
black..'lock_id'..id_group,
black..'lock_spam'..id_group, 
black..'lock_webpage'..id_group,
black..'lock_markdown'..id_group,
black..'lock_flood'..id_group,
black..'lock_bots'..id_group,
black..'mute_forward'..id_group,
black..'mute_contact'..id_group,
black..'mute_location'..id_group,
black..'mute_document'..id_group,
black..'mute_keyboard'..id_group,
black..'mute_game'..id_group,
black..'mute_inline'..id_group,
black..'lock_username'..id_group,
black..'num_msg_black'..id_group,
black..'replay'..id_group
)
redis:srem(black..'group:ids',id_group)
end
...
redis:hset(black..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(black..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(black..'group:add'..msg.chat_id_) then  return '❍ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(black..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(black..':addnumberusers') or 0)
...
local lock_service = redis:get(black..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(black..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(black..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
black..'group:add'..msg.chat_id_,true,
black..'lock_link'..msg.chat_id_,true, 
black..'lock_id'..msg.chat_id_,true,
black..'lock_spam'..msg.chat_id_,true,
black..'lock_webpage'..msg.chat_id_,true,
black..'lock_markdown'..msg.chat_id_,true,
black..'lock_flood'..msg.chat_id_,true,
black..'lock_bots'..msg.chat_id_,true,
black..'mute_forward'..msg.chat_id_,true,
black..'mute_contact'..msg.chat_id_,true,
black..'mute_location'..msg.chat_id_,true,
black..'mute_document'..msg.chat_id_,true,
black..'mute_keyboard'..msg.chat_id_,true,
black..'mute_game'..msg.chat_id_,true,
black..'mute_inline'..msg.chat_id_,true,
black..'lock_username'..msg.chat_id_,true,
black..'num_msg_black'..msg.chat_id_,5, 
black..'replay'..msg.chat_id_,true
)

redis:sadd(black..'group:ids',msg.chat_id_) 
redis:sadd(black..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(black..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(black..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(black..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(black..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(black..'username:'..UserID,'username',Resolv)
redis:sadd(black..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(black..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(black..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(black..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(black..'username:'..UserID,'username',Resolv)
redis:sadd(black..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(black..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(black..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(black..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(black..'username:'..UserID, 'username', Resolv)
redis:sadd(black..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(black..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(black..'whitelist:'..ChatID,UserID)
...
if redis:sismember(black..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(black..'username:'..UserID, 'username', Resolv)
redis:sadd(black..'owners:'..ChatID,UserID)
...
if redis:sismember(black..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(black..'username:'..UserID, 'username', Resolv)
redis:sadd(black..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(black..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(black..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(black..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(black..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(black..'msgs:'..UserID..':'..ChatID) or 1
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر الجوكر ياهه\n") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر البابا جاك\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬.\n") 
elseif redis:sismember(black..':SUDO_BOT:',UserID) then 
...
redis:hset(black..'username:'..UserID, 'username', Resolv)
redis:sadd(black..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(black..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(black..'banned:'..ChatID,UserID)
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم الجوكر ياهه\n") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم البابا جاك\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬.\n") 
elseif redis:sismember(black..':SUDO_BOT:',UserID) then 
...
if redis:sismember(black..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(black..'username:'..UserID, 'username', Resolv)
redis:sadd(black..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(black..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(black..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(black..'username:'..UserID, 'username',Resolv)
redis:sadd(black..'gban_users',UserID)
...
redis:srem(black..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره العام \n',17,USERCAR) 
end
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد الجوكر ياهه\n") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد البابا جاك\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬.\n") 
elseif redis:sismember(black..':SUDO_BOT:',UserID) then 
...
if redis:sismember(black..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(black..'username:'..UserID, 'username', Resolv)
redis:sadd(black..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(black..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(black..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد الجوكر ياهه\n") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد البابا جاك\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬.\n") 
elseif redis:sismember(black..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المطور\n") 
elseif redis:sismember(black..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المنشئ\n") 
...
redis:hset(black..'username:'..UserID, 'username', UserName)
redis:sadd(black..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(black..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'❍ **العضو » ❪ '..UserName..' ❫\n❍ **الايدي » ❪ `'..UserID..'` ❫\n❍ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد الجوكر ياههn") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد البابا جاك\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬.\n") 
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(black..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(black..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(black..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(black..'username:'..UserID, 'username', Resolv)
redis:sadd(black..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(black..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(black..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'❍ **العضو » '..USERNAME..' \n❍ ** الايدي » (`'..UserID..'`)\n❍ **انه بالتأكيد ليس مطور \n') end
redis:srem(black..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك الجوكر ياهه\n")  
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد البابا جاك\n") 
elseif UserID == 1488653639 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬.\n") 
...
if redis:get(black..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(black..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(black..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(black..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*❍*` اعدادات المجموعه :` \n"
.."\n❍ التعديل «» "..(redis:get(black..'lock_edit'..msg.chat_id_) or 'false')
.."\n❍ الروابط «» "..(redis:get(black..'lock_link'..msg.chat_id_) or 'false')
.."\n❍ التاك «» "..(redis:get(black..'lock_tag'..msg.chat_id_) or 'false')
.."\n❍ المعرفات «» "..(redis:get(black..'lock_username'..msg.chat_id_) or 'false')
.."\n❍ التكرار «» "..(redis:get(black..'lock_flood'..msg.chat_id_) or 'false')
.."\n❍ الكلايش «» "..(redis:get(black..'lock_spam'..msg.chat_id_) or 'false')
.."\n❍ الويب «» "..(redis:get(black..'lock_webpage'..msg.chat_id_) or 'false')
.."\n❍ الماركدوان «» "..(redis:get(black..'lock_markdown'..msg.chat_id_) or 'false')
.."\n❍ بالطرد البوتات «» "..(redis:get(black..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n❍ البوتات «» "..(redis:get(black..'lock_bots'..msg.chat_id_) or 'false')
.."\n❍ عدد التكرار «» "..(redis:get(black..'num_msg_black'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍`اعدادات الوسائط :`\n"
.."\n*❍ *المتحركه «» "..(redis:get(black..'mute_gif'..msg.chat_id_) or 'false')
.."\n❍ الدردشه «» "..(redis:get(black..'mute_text'..msg.chat_id_) or 'false')
.."\n❍ الانلاين «» "..(redis:get(black..'mute_inline'..msg.chat_id_) or 'false')
.."\n❍ الالعاب «» "..(redis:get(black..'mute_game'..msg.chat_id_) or 'false')
.."\n❍ الصور «» "..(redis:get(black..'mute_photo'..msg.chat_id_) or 'false')
.."\n❍ الفيديو «» "..(redis:get(black..'mute_video'..msg.chat_id_) or 'false')
.."\n❍ البصمات «» "..(redis:get(black..'mute_audio'..msg.chat_id_) or 'false')
.."\n❍ الصوت «» "..(redis:get(black..'mute_voice'..msg.chat_id_) or 'false')
.."\n❍ الملصقات «» "..(redis:get(black..'mute_sticker'..msg.chat_id_) or 'false')
.."\n❍ الجهات «» "..(redis:get(black..'mute_contact'..msg.chat_id_) or 'false')
.."\n❍ التوجيه «» "..(redis:get(black..'mute_forward'..msg.chat_id_) or 'false')
.."\n❍ الموقع «» "..(redis:get(black..'mute_location'..msg.chat_id_) or 'false')
.."\n❍ الملفات «» "..(redis:get(black..'mute_document'..msg.chat_id_) or 'false')
.."\n❍ الاشعارات «» "..(redis:get(black..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n❍ الكيبورد «» "..(redis:get(black..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*`اعدادات اخرى : `"
.."\n\n*❍*الترحيب «» "..welcomex
.."\n*❍*الردود «» "..replayx
...
.."\n*❍*الويب «» "..(redis:get(black..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*❍*الماركدوان «» "..(redis:get(black..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*❍*البوتات بالطرد «» "..(redis:get(black..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*❍*البوتات «» "..(redis:get(black..'lock_bots'..msg.chat_id_) or 'false')
.."\n*❍*عدد التكرار «» "..(redis:get(black..'num_msg_black'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*اعدادات التقـييد :\n"
.."\n*❍*التقييد بالتوجيه «» "..(redis:get(black..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالصور «» "..(redis:get(black..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالروابط «» "..(redis:get(black..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالمتحركه «» "..(redis:get(black..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد الفيديو «» "..(redis:get(black..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
